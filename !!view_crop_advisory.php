...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div style="padding-top: 40px;">
                <div class="container">
                    ...
                    <div class="row g-2">
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <div class="btn-group btn-group-sm" role="group">
                                    <!-- Changed radio to checkbox for multiple selections -->
                                    <input type="checkbox" class="btn-check" id="none" name="observed_problems[]" value="None">
                                    <label class="btn" for="none">None</label>

                                    <input type="checkbox" class="btn-check" id="yellowing" name="observed_problems[]" value="Yellowing Leaves">
                                    <label class="btn" for="yellowing">Yellowing Leaves</label>

                                    <input type="checkbox" class="btn-check" id="stunted_growth" name="observed_problems[]" value="Stunted Growth">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <label class="btn" for="weed_type_lamb">Lamb’s Quarters</label>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label for="weed_type">Weather Condition</label>
                                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label for="weed_type">Previous Crop</label>
                                <div class="btn-group btn-group-sm" role="group">
        ...
        <script>
            ...
            // Function to generate and display advisory based on selected options
            function generateAdvisory() {
                ...
                const observedProblems = Array.from(document.querySelectorAll('input[name="observed_problems[]"]:checked')).map(input => input.value);
                observedProblems.forEach(problem => processAdvisory("observed_problems", problem));

                // Process current pests
